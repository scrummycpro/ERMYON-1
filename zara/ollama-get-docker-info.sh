...
store_response() {
  ...
  response=$(curl -s http://localhost:11434/api/generate -d '{
    "model": "llama3",
    "prompt": "'"Write a 100-word answer regarding this question in coordination with Docker's functionality, trade-offs, and essential commands, supported by examples and why this matters. Additionally, provide a 3-line rhyme that correlates with this question:$prompt"'",
    "stream": false
  }' | jq -r .response)
